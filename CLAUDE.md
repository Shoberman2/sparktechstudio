...
- Speed and efficiency are how we work, not what we sell. The sell is: we'll actually build that thing you've been thinking about.
...
- `src/components/` - All page sections as individual components (Hero, Features, Showcase, HowItWorks, Beliefs, Waitlist, Navbar, Footer)
